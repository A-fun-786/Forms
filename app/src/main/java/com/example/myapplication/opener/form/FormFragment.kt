 ...
 */
class FormFragment : Fragment(),FormItemImpl, OpenerActivityViewModel.viewModelImpl{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById<RecyclerView>(R.id.form_recyclerview)
        recyclerView.layoutManager = LinearLayoutManager(this.context)
        recyclerView.adapter = FormRecyclerViewAdapter(this)
    }

    override fun onQuestionFocussed(position: Int) {
